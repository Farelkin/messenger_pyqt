...
class TestSocket:
    """
    Тестовый класс для тестирования отпраки и получения,
    при создании требует словарь,
...
class Tests(unittest.TestCase):
    ...
    def test_send_message(self):
        """
        Тестируем корректность работы фукции отправки, создадим
        ...
        # вызов тестируемой функции, результаты будут сохранены
        # в тестовом сокете
        send_message(test_socket, self.test_dict_send)
        # проверка корретности кодирования словаря. сравниваем результат
        # довренного кодирования и результат от тестируемой функции
        self.assertEqual(
            test_socket.encoded_message, test_socket.receved_message)
