from sqlalchemy \
    import create_engine, Table, Column, Integer, String, MetaData, \
    ForeignKey, DateTime
...
class ServerStorage:
    ...
    def user_login(self, username, ip_address, port):
        """
        Функция выполняющяяся при входе пользователя, записывает в базу
        факт входа
        """
        ...
        # о факте входа.
        # Создаем экземпляр класса self.ActiveUsers,
        # через который передаем данные в таблицу
