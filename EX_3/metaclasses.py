...
class ServerMaker(type):
    ...
    def __init__(self, clsname, bases, clsdict):
        ...
        # 'process_message':
        # <function Server.process_message at 0x000000DACCE3E510>,
        # 'process_client_message':
        # <function Server.process_client_message at 0x000000DACCE3E598>}
        ...
        for func in clsdict:
            ...
            try:
                ...
                # ret - <generator object _get_instructions_bytes
                # at 0x00000062EAEAD7C8>
                # ret - <generator object _get_instructions_bytes
                # at 0x00000062EAEADF48>
                # ...
                ...
                for i in ret:
                    print(i)
                    # i - Instruction(
                    # opname='LOAD_GLOBAL', opcode=116, arg=9,
                    # argval='send_message',
        ...
        for command in ('accept', 'listen', 'socket'):
            if command in methods:
                raise TypeError('В классе обнаружено использование '
                                'запрещённого метода')
        # Вызов get_message или send_message из utils считаем
        # корректным использованием сокетов
